  ...
  return (
    <>
      {w > 994 && <div className="coin-video">
        {/* FIRST VIDEO */}
        {w > 1399 && <CoinVideo src={firstvideo} class="first-video" width="400" height="198"/>}
        {w > 1199 && w < 1398 && <CoinVideo src={firstvideo} class="first-video" width="399" height="169"/>}
        {w > 994 && w < 1198 && <CoinVideo src={firstvideo} class="first-video" width="417" height="147"/>}

        {/* SECOND VIDEO */}
        {w > 1399 && <CoinVideo src={secondvideo} class="second-video" width="394" height="200"/>}
        {w > 1199 && w < 1399 && <CoinVideo src={secondvideo} class="second-video" width="495" height="170"/>}
        {w > 994 && w < 1199 && <CoinVideo src={secondvideo} class="second-video" width="444" height="149"/>}
        
        {/* THIRD VIDEO */}
        {w > 1399 && <CoinVideo src={thirdvideo} class="third-video" width="400" height="198"/>}
        {w > 1199 && w < 1399 && <CoinVideo src={thirdvideo} class="third-video" width="338" height="178"/>}
